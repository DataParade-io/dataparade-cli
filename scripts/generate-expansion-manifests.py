...
REPOS = [
    ...
    ("wordpress", "WordPress/wordpress-develop", "98c9e238b806042f83836549f6a2b1f112721e07", "GPL-2.0-or-later",
     ["wp-includes/user.php", "wp-includes/class-wp-user.php", "wp-config-sample.php"], ["php"], ["cms", "identity"]),
